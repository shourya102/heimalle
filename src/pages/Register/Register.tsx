    ...
    return (
        <div className="flex justify-center w-full bg-primary-1">
            <div
                ...
                <div className="text-paragraph3 w-full flex gap-10 items-center">
                    <span className="w-[12px] h-[46px] bg-secondary-1"></span>
                    <input type="text" className="p-20 text-secondary-1 w-full bg-quaternary-5"
                           placeholder="Username"/>
                </div>
                <div className="text-paragraph3 w-full flex gap-10 items-center">
                    <span className="w-[12px] h-[46px] bg-secondary-1"></span>
                    <input type="password" className="p-20 text-secondary-1 w-full bg-quaternary-5"
                           placeholder="Password"/>
                </div>
                <button className="bg-tertiary-3 p-20 text-paragraph3 text-primary-1 w-full">Register</button>
